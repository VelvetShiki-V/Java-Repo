package com.vs._2024_10_18.utils;
...
public class RedisUtil {
    public static String USER_LOGIN_PREFIX = "login:username:";
    public static String CACHE_NULL = "";
    public static long CACHE_NULL_TTL_MINUTES = 10L;
