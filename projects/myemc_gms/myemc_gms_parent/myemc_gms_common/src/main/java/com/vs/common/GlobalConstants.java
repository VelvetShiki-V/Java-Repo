...
public class GlobalConstants {
    ...
    public static final String JWT_PREFIX = SYSTEM_REDIS_KEY_PREFIX + "login:username:";
    ...
    public static final String CREATE_USER_PREFIX = SYSTEM_REDIS_KEY_PREFIX + "add:user:username:";
    // 数据相关
